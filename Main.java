...
public class Main {
	...
	public static void main(String[] args) {
		...
		// ToDo Add 100000 items to the stack by calling the add method in the TwoLiter
		// class. Note that the method is static
		...
		// ToDo Iterate over the stack and compute the total price of all the items. An
		// enhanced for loop is good here.
		double totalPrice = 0;
		...
		// ToDo in the comments here, explain why this number changes each time you run
		// the program.
		...
		int totalDrPepper = 0;
		for (TwoLiter twoLiter : twoLiterStack) {
			if (twoLiter.getFlavor().equals("Dr. Pepper")) {
				totalDrPepper++;
			}
		}
