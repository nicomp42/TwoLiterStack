...
public class TwoLiter {
	private static String[] flavors = { "Coke Classic", "Diet Coke", "Coke Zero", "New Coke", "Cherry Coke",
			"Caffeine Free Coke", "Dr. Pepper" };
	private static String[] UPCs = { "049000050103", "00049000050110", "00049000050141", "xxxxxxxxxxxxxx",
			" 00049000050165", "00049000006131", "00078000082463" };
	private String UPC;
	 ...
	 * Constructor
	 * 
	 * @param UPC    The Universal Product Code that uniquely identifies this type
	 *               of product
...
//			Random r = new Random(42);
		...
		for (int i = 0; i < count; i++) {
			twoLiterStack.add(new TwoLiter(UPCs[r.nextInt(UPCs.length )], flavors[r.nextInt(flavors.length )],
					1.00 + r.nextFloat()));
		}
	}
